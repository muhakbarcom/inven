    ...
    <div class="box">
      ...
      <div class="box-body">
        <div class="row" style="margin-bottom: 10px">
            ...
            <div class="col-md-3 text-right"><form action="<?php echo site_url('jadwal/index'); ?>" class="form-inline" method="get" style="margin-top:10px">
		...
		<td  style="width: 10px;padding-left: 8px;"><input type="checkbox" name="id" value="<?= $jadwal->id_jadwal;?>" />&nbsp;</td>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('jadwal/read/'.$jadwal->id_jadwal),'<i class="fa fa-search"></i>', 'class="btn btn-xs btn-primary"  data-toggle="tooltip" title="Detail"'); 
				echo ' '; 
				echo anchor(site_url('jadwal/update/'.$jadwal->id_jadwal),' <i class="fa fa-edit"></i>', 'class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit"'); 
				echo ' '; 
				echo anchor(site_url('jadwal/delete/'.$jadwal->id_jadwal),' <i class="fa fa-trash"></i>','class="btn btn-xs btn-danger" onclick="javasciprt: return confirmdelete(\'jadwal/delete/'.$jadwal->id_jadwal.'\')"  data-toggle="tooltip" title="Delete" '); 
				?>
			</td>
		</tr>
                <?php
