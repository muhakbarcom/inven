  ...
  <div class="wrapper">
    ...
    <footer class="main-footer">
      <div class="pull-right hidden-xs">
        <b>Developed by<a href="https://<?php echo $copyright ?>.com"> <?php echo $copyright ?></b></a>
      </div>
      <strong>Copyright &copy; <?= date('Y'); ?> <a href="https://<?php echo $copyright ?>.com"><?php echo $copyright ?></a>.</strong> All rights
      reserved.
      <!-- copyright -->
