                                                ...
                                                <div class="col-md-12 border-top">
                                                    <div class="table-responsive mt-3">
                                                        <table width="100%" class="mb-5">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <input type="text" required id="harga_beli" value="<?= set_value('harga_beli') ?>" name="harga_beli" class="form-control text-right count_hr">
                                                                </td>
                                                                <td class="text-center" width="40"></td>
                                                                <td>
                                                                    <input type="text" id="harga_jual" name="harga_jual" value="<?= set_value('harga_jual') ?>" class="form-control text-right count_hr">
                                                                </td>
                                                                <td class="text-center" width="40"></td>
                                                                <td>
                                                                    <input type="text" required id="profit" readonly name="profit" value="<?= set_value('profit') ?>" class="form-control text-right count_hr">
                                                                </td>
