                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" min="1" name="harga_beli" autocomplete="off" class="form-control cus-validate">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="total_harga" readonly class="form-control cus-validate">
                                                </div>
