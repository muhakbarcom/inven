    ...
    public function excel_laporan_stok()
    {
        ...
        foreach ($stok as $data) {
            ...
            $spreadsheet->setActiveSheetIndex(0)
                ...
                ->setCellValue('C' . $kolom, $cabang['nama_cabang'])
                ->setCellValue('D' . $kolom, date('d F Y', $qTgl['tgl']))
    ...
    public function excel_laporan_stok_c($id)
    {
        ...
        foreach ($stok as $data) {
            ...
            $spreadsheet->setActiveSheetIndex(0)
                ...
                ->setCellValue('D' . $kolom, $pemasukan['jumlah'] . ' ' . $data['satuan'])
                ->setCellValue('E' . $kolom, $i)
                ->setCellValue('F' . $kolom, $data['stok'] . ' ' . $data['satuan']);
