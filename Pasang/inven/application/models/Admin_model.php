...
class Admin_model extends CI_Model
{
  ...
  <div id="didie"></div>
    ...
    public function am_search_history()
    {
        ...
        $no = 1;
        $output .= '
        <a href="'.base_url('export/excel_history_penjualan_ex/'.$dari.'/'.$ke.'/'.$penempatan).'" target="_blank" class="btn btn-outline-warning btn-sm mb-4" title="Export Ke Excel"><i class="fas fa-file-excel"></i> Export Ke Excel</a>
        <table class="table table-striped" id="table-89">
            <thead>
                <tr>
                    <th width="30" class="text-center">
    ...
    public function am_search_data_jual_hari()
    {
        ...
        $no = 1;
        $output .= '
        <a href="'.base_url('export/excel_data_penjualan_hari_ex/'.$dari.'/'.$ke.'/'.$penempatan).'" target="_blank" class="btn btn-outline-warning btn-sm mb-4" title="Export Ke Excel"><i class="fas fa-file-excel"></i> Export Ke Excel</a>
        <table class="table table-striped" id="table-89">
            <thead>
                <tr>
                    <th width="30" class="text-center">
    ...
    public function am_search_history_pengeluaran()
    {
        ...
        $no = 1;
        $output .= '
        <a href="'.base_url('export/excel_data_pengeluaran_ex/'.$dari.'/'.$ke.'/'.$user['penempatan_cabang']).'" target="_blank" class="btn btn-outline-warning btn-sm mb-4" title="Export Ke Excel"><i class="fas fa-file-excel"></i> Export Ke Excel</a>
    <table class="table table-striped" id="table-89">
    <thead>
        <tr>
            <th width="30" class="text-center">
    ...
    public function am_search_data_pengeluaran_hari()
    {
        ...
        $no = 1;
        $output .= '
        <a href="'.base_url('export/excel_data_pengeluaran_hari_ex/'.$dari.'/'.$ke.'/'.$penempatan).'" target="_blank" class="btn btn-outline-warning btn-sm mb-4" title="Export Ke Excel"><i class="fas fa-file-excel"></i> Export Ke Excel</a>
        <table class="table table-striped" id="table-89">
        <thead>
        <tr>
            <th width="30" class="text-center">
